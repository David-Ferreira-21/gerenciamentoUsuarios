        ...
        <nav class="navbar navbar-expand-sm navbar-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="<?= URL ?>/gerenciar_usuarios/index" data-tooltip="tooltip" title="Página Inicial">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= URL ?>/paginas/sobre" data-tooltip="tooltip" title="Sobre nós">Cadastros</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= URL ?>/paginas/sobre" data-tooltip="tooltip" title="Sobre nós">Serviços</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= URL ?>/paginas/sobre" data-tooltip="tooltip" title="Sobre nós">Funções Usuarios</a>
                    </li>
                </ul>
                   <?php endif; ?>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?= URL ?>/paginas/sobre" data-tooltip="tooltip" title="Sobre nós">Funções Usuários</a>
                    </li>
                </ul>
                   <?php endif; ?>
